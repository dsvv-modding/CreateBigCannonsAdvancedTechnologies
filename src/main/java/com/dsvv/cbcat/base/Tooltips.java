...
public class    Tooltips {
    public static <T extends Block & TwinAutocannonBlock> void appendTextTwinAutocannon(ItemStack stack, List<Component> tooltip, TooltipFlag flag, T block) {
    ...
    public static <T extends Block & HeavyAutocannonBlock> void appendTextHeavyAutocannon(ItemStack stack, List<Component> tooltip, TooltipFlag flag, T block) {
        boolean desc = Screen.hasShiftDown();
        addHoldShift(desc, tooltip);
        if (!desc) {
            return;
