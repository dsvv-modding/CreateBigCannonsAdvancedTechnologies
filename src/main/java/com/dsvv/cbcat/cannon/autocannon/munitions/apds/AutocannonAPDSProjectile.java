...
public class AutocannonAPDSProjectile extends AbstractAutocannonProjectile {

    public AutocannonAPDSProjectile(EntityType<? extends AbstractAutocannonProjectile> type, Level level) {
        super(type, level);
    }
