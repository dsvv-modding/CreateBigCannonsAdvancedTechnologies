...
public class AutocannonHEProjectileItem extends AutocannonRoundItem implements FuzedItemMunition {
    public AutocannonHEProjectileItem(Properties properties) {
        super(properties);
    }
    ...
    public AbstractAutocannonProjectile getAutocannonProjectile(ItemStack stack, Level level) {
        AutocannonHEProjectile projectile = EntityRegister.HE_PROJECTILE.create(level);
        CompoundTag tag = stack.getOrCreateTag();
    ...
    public EntityType<?> getEntityType(ItemStack itemStack) {
        return EntityRegister.HE_PROJECTILE.get();
    }
