...
public class HA_APDSFSProjectileItem extends AbstractHeavyAutocannonProjectileItem
{
    public HA_APDSFSProjectileItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public AbstractHeavyAutocannonProjectile getAutocannonProjectile(ItemStack stack, Level level) {
        return EntityRegister.HA_APDSFS_PROJECTILE.create(level);
    }

    @Override
    public EntityType<?> getEntityType(ItemStack stack) {
        return EntityRegister.HA_APDSFS_PROJECTILE.get();
    }
}