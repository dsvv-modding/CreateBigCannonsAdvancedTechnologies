...
public class MediumRocketRenderer<T extends AbstractMediumRocket> extends EntityRenderer<T> {
    ...
    public MediumRocketRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
    }
    ...
    public void render(T entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffers, int packedLight) {
        /*if (true) {
            ...
            float thickness = 4 / 32f;//entity.getAutocannonRoundType() == AutocannonAmmoType.MACHINE_GUN ? 1 / 32f : 2 / 32f;
    ...
    public boolean shouldRender(T entity, Frustum frustrum, double x, double y, double z) {
        return true;///*entity.isTracer() ||*/ super.shouldRender(entity, frustrum, x, y, z);
    }
