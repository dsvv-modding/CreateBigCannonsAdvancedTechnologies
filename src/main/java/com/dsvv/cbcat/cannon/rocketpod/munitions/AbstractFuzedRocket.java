...
import com.dsvv.cbcat.mixin.AbstractAutocannonProjectileMixin;
...
public abstract class AbstractFuzedRocket<T extends AbstractAutocannonProjectile> extends AbstractRocket<T> {

    protected ItemStack fuze = ItemStack.EMPTY;

    protected AbstractFuzedRocket(EntityType<? extends AbstractRocket> type, Level level, double thrust, double maxVelocity, EntityEntry<T> autocannonProjectileEntry) {
