...
public class BlockEntityRegister
{
    public static final BlockEntityEntry<MuzzleBrakeBlockEntity> MUZZLE_BRAKE_BLOCK_ENTITY = REGISTRATE.blockEntity("muzzle_brake_be", MuzzleBrakeBlockEntity::new)
            .validBlocks(BlockRegister.CAST_IRON_MUZZLE_BRAKE, BlockRegister.BRONZE_MUZZLE_BRAKE, BlockRegister.STEEL_MUZZLE_BRAKE, BlockRegister.NETHERSTEEL_MUZZLE_BRAKE,
                    BlockRegister.UNBORED_CAST_IRON_MUZZLE_BRAKE, BlockRegister.UNBORED_BRONZE_MUZZLE_BRAKE, BlockRegister.UNBORED_STEEL_MUZZLE_BRAKE, BlockRegister.UNBORED_NETHERSTEEL_MUZZLE_BRAKE)
            .register();
    ...
    public static final BlockEntityEntry<FumeExtractorBlockEntity> FUME_EXTRACTOR_BLOCK_ENTITY = REGISTRATE.blockEntity("fume_extractor_be", FumeExtractorBlockEntity::new)
            .validBlocks(BlockRegister.CAST_IRON_FUME_EXTRACTOR, BlockRegister.BRONZE_FUME_EXTRACTOR, BlockRegister.STEEL_FUME_EXTRACTOR, BlockRegister.NETHERSTEEL_FUME_EXTRACTOR,
                    BlockRegister.UNBORED_CAST_IRON_FUME_EXTRACTOR, BlockRegister.UNBORED_BRONZE_FUME_EXTRACTOR, BlockRegister.UNBORED_STEEL_FUME_EXTRACTOR, BlockRegister.UNBORED_NETHERSTEEL_FUME_EXTRACTOR)
            .register();
    ...
    public static final BlockEntityEntry<SilencerBlockEntity> SILENCER_BLOCK_ENTITY = REGISTRATE.blockEntity("silencer_be", SilencerBlockEntity::new)
            .validBlocks(BlockRegister.CAST_IRON_SILENCER, BlockRegister.BRONZE_SILENCER, BlockRegister.STEEL_SILENCER, BlockRegister.NETHERSTEEL_SILENCER,
                    BlockRegister.UNBORED_CAST_IRON_SILENCER, BlockRegister.UNBORED_BRONZE_SILENCER, BlockRegister.UNBORED_STEEL_SILENCER, BlockRegister.UNBORED_NETHERSTEEL_SILENCER,
    ...
    public static final BlockEntityEntry<RifledBarrelBlockEntity> RIFLED_BARREL_BLOCK_ENTITY = REGISTRATE.blockEntity("rifled_barrel_be", RifledBarrelBlockEntity::new)
            .validBlocks(BlockRegister.CAST_IRON_RIFLED_BARREL, BlockRegister.BRONZE_RIFLED_BARREL, BlockRegister.STEEL_RIFLED_BARREL, BlockRegister.NETHERSTEEL_RIFLED_BARREL,
                    BlockRegister.UNBORED_CAST_IRON_RIFLED_BARREL, BlockRegister.UNBORED_BRONZE_RIFLED_BARREL, BlockRegister.UNBORED_STEEL_RIFLED_BARREL, BlockRegister.UNBORED_NETHERSTEEL_RIFLED_BARREL,
    ...
    public static final BlockEntityEntry<RocketPodBlockEntity> ROCKET_POD_BARREL_BLOCK_ENTITY = REGISTRATE.blockEntity("rocket_pod_barrel_be", RocketPodBlockEntity::new)
            .validBlocks(BlockRegister.CAST_IRON_ROCKET_POD_BARREL, BlockRegister.BRONZE_ROCKET_POD_BARREL, BlockRegister.STEEL_ROCKET_POD_BARREL,
                    BlockRegister.UNBORED_CAST_IRON_ROCKET_POD_BARREL, BlockRegister.UNBORED_BRONZE_ROCKET_POD_BARREL, BlockRegister.UNBORED_STEEL_ROCKET_POD_BARREL)
            .register();
    ...
    public static final BlockEntityEntry<RocketPodBreechBlockEntity> ROCKET_POD_BREECH_BLOCK_ENTITY = REGISTRATE.blockEntity("rocket_pod_breech_be", RocketPodBreechBlockEntity::new)
            .validBlocks(BlockRegister.CAST_IRON_ROCKET_POD_BREECH, BlockRegister.BRONZE_ROCKET_POD_BREECH, BlockRegister.STEEL_ROCKET_POD_BREECH,
                    BlockRegister.UNBORED_CAST_IRON_ROCKET_POD_BREECH, BlockRegister.UNBORED_BRONZE_ROCKET_POD_BREECH, BlockRegister.UNBORED_STEEL_ROCKET_POD_BREECH)
            .register();
    ...
    public static final BlockEntityEntry<MediumRocketPodBlockEntity> MEDIUM_ROCKET_POD_BARREL_BLOCK_ENTITY = REGISTRATE.blockEntity("medium_rocket_rail_be", MediumRocketPodBlockEntity::new)
            .validBlocks(BlockRegister.WROUGHT_IRON_MEDIUM_ROCKET_RAIL)
            .register();
    ...
    public static final BlockEntityEntry<AutocannonBlockEntity> SPECIAL_AUTOCANNON_BLOCK_ENTITY = REGISTRATE.blockEntity("special_autocannon_be", AutocannonBlockEntity::new)
            .validBlocks(BlockRegister.CAST_IRON_AUTOCANNON_MUZZLE_BRAKE, BlockRegister.BRONZE_AUTOCANNON_MUZZLE_BRAKE, BlockRegister.STEEL_AUTOCANNON_MUZZLE_BRAKE,
                    BlockRegister.CAST_IRON_AUTOCANNON_SILENCER, BlockRegister.BRONZE_AUTOCANNON_SILENCER, BlockRegister.STEEL_AUTOCANNON_SILENCER,
                    BlockRegister.UNBORED_CAST_IRON_AUTOCANNON_MUZZLE_BRAKE, BlockRegister.UNBORED_BRONZE_AUTOCANNON_MUZZLE_BRAKE, BlockRegister.UNBORED_STEEL_AUTOCANNON_MUZZLE_BRAKE,
                    BlockRegister.UNBORED_CAST_IRON_AUTOCANNON_SILENCER, BlockRegister.UNBORED_BRONZE_AUTOCANNON_SILENCER, BlockRegister.UNBORED_STEEL_AUTOCANNON_SILENCER)
            .register();
    ...
    public static final BlockEntityEntry<TwinAutocannonBlockEntity> TWIN_AUTOCANNON_BLOCK_ENTITY = REGISTRATE.blockEntity("twin_autocannon_be", TwinAutocannonBlockEntity::new)
            ...
            .validBlocks(BlockRegister.CAST_IRON_TWIN_AUTOCANNON_BARREL, BlockRegister.BRONZE_TWIN_AUTOCANNON_BARREL, BlockRegister.STEEL_TWIN_AUTOCANNON_BARREL,
                    ...
                    BlockRegister.UNBORED_CAST_IRON_TWIN_AUTOCANNON_BARREL, BlockRegister.UNBORED_BRONZE_TWIN_AUTOCANNON_BARREL, BlockRegister.UNBORED_STEEL_TWIN_AUTOCANNON_BARREL,
                    BlockRegister.UNBORED_CAST_IRON_VERT_TWIN_AUTOCANNON_BARREL, BlockRegister.UNBORED_BRONZE_VERT_TWIN_AUTOCANNON_BARREL, BlockRegister.UNBORED_STEEL_VERT_TWIN_AUTOCANNON_BARREL,
                    BlockRegister.UNBORED_CAST_IRON_TWIN_AUTOCANNON_SILENCER, BlockRegister.UNBORED_BRONZE_TWIN_AUTOCANNON_SILENCER, BlockRegister.UNBORED_STEEL_TWIN_AUTOCANNON_SILENCER,
                    BlockRegister.UNBORED_CAST_IRON_VERT_TWIN_AUTOCANNON_SILENCER, BlockRegister.UNBORED_BRONZE_VERT_TWIN_AUTOCANNON_SILENCER, BlockRegister.UNBORED_STEEL_VERT_TWIN_AUTOCANNON_SILENCER,
                    BlockRegister.UNBORED_CAST_IRON_TWIN_AUTOCANNON_MUZZLE_BRAKE, BlockRegister.UNBORED_BRONZE_TWIN_AUTOCANNON_MUZZLE_BRAKE, BlockRegister.UNBORED_STEEL_TWIN_AUTOCANNON_MUZZLE_BRAKE,
                    BlockRegister.UNBORED_CAST_IRON_VERT_TWIN_AUTOCANNON_MUZZLE_BRAKE, BlockRegister.UNBORED_BRONZE_VERT_TWIN_AUTOCANNON_MUZZLE_BRAKE, BlockRegister.UNBORED_STEEL_VERT_TWIN_AUTOCANNON_MUZZLE_BRAKE)
            .register();
    ...
    public static final BlockEntityEntry<TwinAutocannonRecoilSpringBlockEntity> TWIN_AUTOCANNON_RECOIL_SPRING_BLOCK_ENTITY = REGISTRATE.blockEntity("twin_autocannon_recoil_spring_be", TwinAutocannonRecoilSpringBlockEntity::new)
            ...
            .validBlocks(BlockRegister.CAST_IRON_TWIN_AUTOCANNON_RECOIL_SPRING, BlockRegister.BRONZE_TWIN_AUTOCANNON_RECOIL_SPRING, BlockRegister.STEEL_TWIN_AUTOCANNON_RECOIL_SPRING,
                    ...
                    BlockRegister.UNBORED_CAST_IRON_TWIN_AUTOCANNON_RECOIL_SPRING, BlockRegister.UNBORED_BRONZE_TWIN_AUTOCANNON_RECOIL_SPRING, BlockRegister.UNBORED_STEEL_TWIN_AUTOCANNON_RECOIL_SPRING,
                    BlockRegister.UNBORED_CAST_IRON_VERT_TWIN_AUTOCANNON_RECOIL_SPRING, BlockRegister.UNBORED_BRONZE_VERT_TWIN_AUTOCANNON_RECOIL_SPRING, BlockRegister.UNBORED_STEEL_VERT_TWIN_AUTOCANNON_RECOIL_SPRING)
            .register();
    ...
    public static final BlockEntityEntry<TwinAutocannonBreechBlockEntity> TWIN_AUTOCANNON_BREECH_BLOCK_ENTITY = REGISTRATE.blockEntity("twin_autocannon_breech_be", TwinAutocannonBreechBlockEntity::new)
            ...
            .validBlocks(BlockRegister.CAST_IRON_TWIN_AUTOCANNON_BREECH, BlockRegister.BRONZE_TWIN_AUTOCANNON_BREECH, BlockRegister.STEEL_TWIN_AUTOCANNON_BREECH,
                    ...
                    BlockRegister.UNBORED_CAST_IRON_TWIN_AUTOCANNON_BREECH, BlockRegister.UNBORED_BRONZE_TWIN_AUTOCANNON_BREECH, BlockRegister.UNBORED_STEEL_TWIN_AUTOCANNON_BREECH,
                    BlockRegister.UNBORED_CAST_IRON_VERT_TWIN_AUTOCANNON_BREECH, BlockRegister.UNBORED_BRONZE_VERT_TWIN_AUTOCANNON_BREECH, BlockRegister.UNBORED_STEEL_VERT_TWIN_AUTOCANNON_BREECH)
            .register();
    ...
    public static final BlockEntityEntry<HeavyAutocannonBlockEntity> HEAVY_AUTOCANNON_BLOCK_ENTITY = REGISTRATE.blockEntity("heavy_autocannon_be", HeavyAutocannonBlockEntity::new)
            .validBlocks(BlockRegister.CAST_IRON_HEAVY_AUTOCANNON_BARREL, BlockRegister.BRONZE_HEAVY_AUTOCANNON_BARREL, BlockRegister.STEEL_HEAVY_AUTOCANNON_BARREL,
                    ...
                    BlockRegister.UNBORED_CAST_IRON_HEAVY_AUTOCANNON_BARREL, BlockRegister.UNBORED_BRONZE_HEAVY_AUTOCANNON_BARREL, BlockRegister.UNBORED_STEEL_HEAVY_AUTOCANNON_BARREL,
                    BlockRegister.UNBORED_CAST_IRON_HEAVY_AUTOCANNON_MUZZLE_BRAKE, BlockRegister.UNBORED_BRONZE_HEAVY_AUTOCANNON_MUZZLE_BRAKE, BlockRegister.UNBORED_STEEL_HEAVY_AUTOCANNON_MUZZLE_BRAKE,
                    BlockRegister.UNBORED_CAST_IRON_HEAVY_AUTOCANNON_SILENCER, BlockRegister.UNBORED_BRONZE_HEAVY_AUTOCANNON_SILENCER, BlockRegister.UNBORED_STEEL_HEAVY_AUTOCANNON_SILENCER)
            .register();
    ...
    public static final BlockEntityEntry<HeavyAutocannonRecoilSpringBlockEntity> HEAVY_AUTOCANNON_RECOIL_SPRING_BLOCK_ENTITY = REGISTRATE.blockEntity("heavy_autocannon_recoil_spring_be", HeavyAutocannonRecoilSpringBlockEntity::new)
            ...
            .validBlocks(BlockRegister.CAST_IRON_HEAVY_AUTOCANNON_RECOIL_SPRING, BlockRegister.BRONZE_HEAVY_AUTOCANNON_RECOIL_SPRING, BlockRegister.STEEL_HEAVY_AUTOCANNON_RECOIL_SPRING,
                    BlockRegister.UNBORED_CAST_IRON_HEAVY_AUTOCANNON_RECOIL_SPRING, BlockRegister.UNBORED_BRONZE_HEAVY_AUTOCANNON_RECOIL_SPRING, BlockRegister.UNBORED_STEEL_HEAVY_AUTOCANNON_RECOIL_SPRING)
            .register();
    ...
    public static final BlockEntityEntry<HeavyAutocannonBreechBlockEntity> HEAVY_AUTOCANNON_BREECH_BLOCK_ENTITY = REGISTRATE.blockEntity("heavy_autocannon_breech_be", HeavyAutocannonBreechBlockEntity::new)
            ...
            .validBlocks(BlockRegister.CAST_IRON_HEAVY_AUTOCANNON_BREECH, BlockRegister.BRONZE_HEAVY_AUTOCANNON_BREECH, BlockRegister.STEEL_HEAVY_AUTOCANNON_BREECH,
                    BlockRegister.UNBORED_CAST_IRON_HEAVY_AUTOCANNON_BREECH, BlockRegister.UNBORED_BRONZE_HEAVY_AUTOCANNON_BREECH, BlockRegister.UNBORED_STEEL_HEAVY_AUTOCANNON_BREECH)
            .register();
    ...
    public static final BlockEntityEntry<HeavyAutocannonQuickFireBreechBlockEntity> HEAVY_AUTOCANNON_QFBREECH_BLOCK_ENTITY = REGISTRATE.blockEntity("heavy_autocannon_qf_breech_be", HeavyAutocannonQuickFireBreechBlockEntity::new)
            ...
            .validBlocks(BlockRegister.CAST_IRON_HEAVY_AUTOCANNON_QFBREECH, BlockRegister.BRONZE_HEAVY_AUTOCANNON_QFBREECH, BlockRegister.STEEL_HEAVY_AUTOCANNON_QFBREECH,
                    BlockRegister.UNBORED_CAST_IRON_HEAVY_AUTOCANNON_QFBREECH, BlockRegister.UNBORED_BRONZE_HEAVY_AUTOCANNON_QFBREECH, BlockRegister.UNBORED_STEEL_HEAVY_AUTOCANNON_QFBREECH)
            .register();
